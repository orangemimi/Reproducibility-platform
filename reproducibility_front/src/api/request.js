...
export async function getPublicProjects(currentPage, pageSize) {
  return await get(`/projects/getPublicProjects/${currentPage}/${pageSize}`);
}
...
export async function getFileItemByStoreyAndParent(storey, parent) {
  return await get(
    `/fileItems/getFileItemByStoreyAndParent/${storey}/${parent}`
  );
}
...
export async function getResultByTaskId(projectId) {
  return await get(
    `/integrateTasks/getIntegrateTaskResultByTaskId/${projectId}`
  );
}
...
export async function getAllIntegrateTaskInstancesByTaskId(
  taskId,
  currentPage,
  pagesize
) {
  return await get(
    `/integrateTaskInstances/${taskId}/${currentPage}/${pagesize}`
  );
}
...
export async function getInstanceOfUncompleted(taskId) {
  return await get(
    `/integrateTaskInstances/getInstanceOfUncompleted/${taskId}`
  );
}
...
export async function getAllInstances(taskId, page, size) {
  return await get(
    `/integrateTaskInstances/getAllIntegrateTaskInstance/${taskId}/${page}/${size}`
  );
}
export async function getSelectedInstancesByProjectId(projectId) {
  return await get(
    `/integrateTaskInstances/getSelectedInstancesByProjectId/${projectId}`
  );
}

export async function getAllInstancesOfReproductionByProjectId(projectId) {
  return await get(
    `/integrateTaskInstances/getAllInstancesOfReproductionByProjectId/${projectId}`
  );
}
...
export async function getAvailableModels(currentPage, pagesize) {
  let data = await get(`/modelItems/userAvailable/${currentPage}/${pagesize}`);
  console.log(data);
  return data;
}
