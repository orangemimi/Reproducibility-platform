...
export class Graph extends mxGraph {
    ...
    setBox() {
        mxUtils.extend(this.BoxShape, mxCylinder);
        this.BoxShape.prototype.extrude = 10;
        this.BoxShape.prototype.redrawPath = function (
            path,
            x,
            y,
            w,
        ...
        mxCellRenderer.registerShape("box", this.BoxShape);
    }
