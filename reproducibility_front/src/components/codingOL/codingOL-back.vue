...
import Api from './construction.js'
...
<el-dialog title="输入文件夹名称" width="400px">
...
<el-dialog title="输入文件名称" width="400px">
...
<el-dialog title="创建新项目" width="400px">
        <span>项目名称</span>
...
<el-dialog title="确认要删除该项目吗？" width="400px">
...
<el-dialog title="输入新名称" width="400px">
