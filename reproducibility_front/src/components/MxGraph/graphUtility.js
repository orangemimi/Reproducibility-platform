...
//       Math.min(
//         pad.x,
//         (vueItem.graph.container.scrollWidth -
//           vueItem.graph.container.clientWidth) /
//           2
//       )
//     ) - 1
...
//       bounds.x >
//       vueItem.graph.container.scrollLeft +
//         vueItem.graph.container.clientWidth * 0.9
//     ) {
...
//     if (
//       bounds.y >
//       vueItem.graph.container.scrollTop +
//         vueItem.graph.container.clientHeight * 0.9
//     ) {
...
//       0,
//       Math.round(
//         (vueItem.graph.container.offsetWidth - 34) / vueItem.graph.view.scale
//       )
//     ),
//     Math.max(
//       0,
//       Math.round(
//         (vueItem.graph.container.offsetHeight - 34) / vueItem.graph.view.scale
//       )
//     )
//   )
// }
...
//   }
//   let x = Math.ceil(
//     bounds.x / vueItem.graph.view.scale - vueItem.graph.view.translate.x
//   )
//   let y = Math.ceil(
//     bounds.y / vueItem.graph.view.scale - vueItem.graph.view.translate.y
//   )
...
//       dx =
//         vueItem.graph.container.offsetWidth / 2 -
//         vueItem.cursorPosition.x +
//         offset.x
//       dy =
//         vueItem.graph.container.offsetHeight / 2 -
//         vueItem.cursorPosition.y +
//         offset.y
//     }
...
// //                         <path d="${d.join(
// //                           ' '
// //                         )}" fill="none" stroke="${color}" opacity="0.2" stroke-width="1"/>
...
// //     }
// //     let tmpGridBackgroundColor = graphConfig.gridBackgroundEnabled
...
// //     return new mxRectangle(
// //       scale * (translate.x + layout.x * page.width),
