    ...
    <div class="customToolbarContainer">
      ...
      <div class="mainContainer">
        <div class="toolbarTop">
          ...
          <el-button @click="exportGraph" type="text" size="default"
          ...
          <el-button @click="undo" type="text" size="default">Undo</el-button>
          <el-button @click="redo" type="text" size="default">Redo</el-button>
      ...
      <div class="dialogs">
        <el-dialog v-model="deleteCellsVisible" width="30%">
