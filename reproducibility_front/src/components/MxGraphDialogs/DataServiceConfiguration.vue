  ...
  <div class="main">
    ...
    <div class="event">
      ...
      <el-row :gutter="10" v-if="stateListParameter.length > 0">
        <div
          v-for="(modelInEvent, inEventIndex) in stateListParameter"
          :ref="getRefSetter('inputItemList')"
          class="event-desc"
          :key="inEventIndex"
        >
...
export default {
  ...
  methods: {
    ...
    async getDataServiceInfoByPortal() {
      let data = await getDataServiceInfoByPortal(
        this.cell.nodeAttribute.oid,
        this.cell.nodeAttribute.dataServiceId
      )
      console.log(data)
