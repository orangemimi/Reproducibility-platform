...
export default {
  ...
  methods: {
    ...
    handleNodeClick(data) {
      ...
      this.treeEvent.datasetItem.dataName = data.name + data.suffix;
      // console.log("datadatadatadata", this.treeEvent.datasetItem);
      this.treeEvent.datasetItem.valueName = data.name;
      //   this.$forceUpdate();
  ...
  mounted() {
    console.log(this.treeData, this.treeEvent, "tree");
  },
  emits: ["refreshData"],
};
</script>
