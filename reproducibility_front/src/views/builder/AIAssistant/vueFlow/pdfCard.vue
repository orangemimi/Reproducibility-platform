<template>
  <div>
    <button
      class="flex w-full items-center justify-between rounded-2xl bg-white border hover:border-indigo-300 p-2 mb-3 shadow-3xl shadow-shadow-500"
      @click="navigate"
    >
      <div class="flex items-center">
        <div class="">
          ...
          >
            ...
            <path
              ...
              p-id="12292"
            ></path>
            <path d="M768 320l256 256V320z" opacity=".1" p-id="12293"></path>
            <path
        ...
        <div class="ml-4" style="text-align: left">
          ...
          <p class="mt-2 text-sm text-gray-600">{{ props.fileSize }}</p>
        </div>
      </div>
    </button>
  </div>
