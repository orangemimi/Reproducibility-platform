  ...
  <div>
    <el-form ref="form" :model="form" label-width="90px" size="mini">
      ...
      <el-form-item label="File">
        <div style="width: 100%">
          <el-radio
            ...
            label="1"
            style="width: 60px"
            :disabled="form.type == '' || form.type != 'input'"
            >User</el-radio
          >
          <el-input
            ...
            "
            :disabled="
              form.type == '' || form.type != 'input' || form.radio == '2'
            "
            :readonly="true"
          >
        ...
        <div style="width: 100%">
          ...
          <el-input
            ...
            "
            :disabled="
              form.type == '' || form.type != 'input' || form.radio == '1'
            "
            :readonly="true"
          >
            <template v-slot:append>
      ...
      <el-form-item label="Data Type">
        <el-radio
          :disabled="form.type == '' || form.type == 'parameter'"
      ...
      <el-form-item label="Share_Id">
        <el-input
          :disabled="form.type == '' || form.type != 'share_file'"
  ...
  methods: {
    async onSubmit() {
      ...
      if (this.form.type == 'input') {
        if (
          (this.form.radio == '1' && this.form.inputUser == '') ||
          (this.form.radio == '2' && this.form.inputLocal == '')
        ) {
