  ...
  <div>
    ...
    <el-dialog title="上下文定义" :visible.sync="contextVisible">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="contextVisible = false">Cancel</el-button>
        <el-button type="primary" @click="setContext()">Submit</el-button>
      </div>
    </el-dialog>
    ...
    >
      <!-- <vue-scroll :ops="ops" style="max-height: 390px;">
            <div
              v-for="(data, index) in resourceCollect.dataServices"
              :key="index"
              ref="modelItemList"
            >
              {{ data }}
              <div class="choose-model-contain"></div>
            </div> </vue-scroll
        > -->
