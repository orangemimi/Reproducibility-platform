<template>
  <div>
    ...
    <div class="select" v-if="selectFlag">
      <el-select
        v-model="classValue"
        placeholder="Please select your article type"
        size="small"
          ...
          <el-row>
            <el-col :span="8">
              <el-date-picker
                v-model="date.year"
                type="year"
                placeholder="Accurate to the year"
                @change="change(1)"
              ></el-date-picker>
            </el-col>
            <el-col :span="8">
              <el-date-picker
                v-model="date.month"
                type="month"
                placeholder="Accurate to the month"
                @change="change(2)"
              ></el-date-picker>
            </el-col>
            <el-col :span="8">
              <el-date-picker
                v-model="date.date"
                type="date"
                placeholder="Accurate to the date"
                @change="change(3)"
              ></el-date-picker>
            </el-col>
          </el-row>
