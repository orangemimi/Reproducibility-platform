<template>
  <div>
    <div>
      ...
      >
        <el-row style="float: left; margin: 5px 10px 10px 0">
          <div>
            ...
            <div style="float: left; margin-right: 10px;margin-top: 5px">{{ activeNames }}</div>
          </div>
        </el-row>
        <el-input
      ...
      <div v-else>
        <el-empty style="width: 300px;" description="Please add the resources first"></el-empty>
      </div>
    </div>
